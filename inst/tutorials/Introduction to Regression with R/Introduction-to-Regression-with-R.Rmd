...
question("For the regression model coded in R as $test_{score} \\sim age$, how many regression coefficients are there?",
           answer("1"),
           answer("2", correct = TRUE),
           answer("3"),
           answer("4")),

question("For the regression model  coded in R as $test_{score} \\sim 1$, how many regression coefficients are there?",
           answer("1", correct = TRUE),
           answer("2"),
           answer("3"),
           answer("4")),

question("For the full model $y \\sim age + education_years$, which of these are valid null models? Select all that apply",
           answer("$y \\sim 1$", correct = TRUE),
           answer("$y \\sim age + sex$"),
           answer("$y \\sim age + status$"),
           answer("$y \\sim education_years + age$"))
)
```
