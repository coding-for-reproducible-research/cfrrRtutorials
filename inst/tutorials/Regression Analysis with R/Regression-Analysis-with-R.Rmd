...
You can navigate through the section using the menu on the side. Please note that the data required for the examples and exercises is predloaded within this interactive document, so the commands/exercises only work within it. They won't work with the Rstudio console. When you come to run them on your own datasets, you will need to ensure your data is loaded and edit the syntax to model the relevant variables. 
...
What you should observe is that changing $\beta_{1}$ changes the slope of the line: 
