...
question("What is the correlation between individual specific random intercepts and random slopes for cognitive score B?",
  ...
  allow_retry = TRUE),
question("The random slope significantly improves the model fit for which cognitive score?",
  answer("Neither B or C", correct = TRUE),
  answer("B only"),
  answer("C only"),
  answer("Both B & C"),
  allow_retry = TRUE)
...
In general, sample size is a bigger issue for mixed effects models compared to standard regression models, as data feature multiple levels.
The level-2 sample size (i.e. number of groups) is the most important factor for determining whether the model will be afflicted by small sample issues.
