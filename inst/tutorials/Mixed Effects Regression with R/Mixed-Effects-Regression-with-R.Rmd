...
question("Which cognitive tests significantly influence mental well being? Select all that apply",
  ...
  answer("None", correct = TRUE),
  allow_retry = TRUE),
question("Which cognitive tests are associated with increasing mental well being from low to high? You can ignore whether they are significant or not and use the results from the models testing each cognitive test on it's own. Select all that apply.",
  answer("Cognition B"),
  answer("Cognition C"),
  answer("Both cognition B & C", correct = TRUE),  
  answer("None"),
  allow_retry = TRUE), 
...
question("For cognitive test C, which of the following statements is true?",
  ...
  answer("Cognition decreases on average per visit for all samples."),
  answer("Cognition increases on average per visit for the Placebo group only."),
  answer("Cognition increases on average per visit for the Training group only.", correct = TRUE),
  allow_retry = TRUE)
)
```
